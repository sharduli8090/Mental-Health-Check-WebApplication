...
function shown(){
    ...
    "Often we have heard this statement that if you are healthy then no one can stop you from being wealthy. We always follow this statement but often we forget that health is not stuck to physical health only, but this is not at all true, mental health is also important. Mental health is the most important part and can't be ignored at any cost! Sometimes we don't even get to know that we are suffering from this disease. Also when people get to know about this disease they try to hide this, because of society's fears. But it's completely normal or ok to have depression or similar. It's like any other disease, which needs to be detected at earlier stages to avoid any hazardous conditions! For that, we first need to do some screening tests at our level. This is a small test designed for self-screening of depression. It hardly takes less than 10 minutes to complete this test but can become a life savior for you or your close ones! It is an anonymous test and data is asked just for evaluation purposes only. If you are 16 or above you can take this test!"+
    '</div>'+
    '<div id="footerDisclamair">Creativstan By <i>Sharduli Pandey</i></div>'+
